...
CONSOLE_INTRODUCTION = "Welcome to the " + CONSOLE_DESCRIPTION + "!"

# Console ASCII tables
NAME_HEADER_NAME = 'Name'
PATH_HEADER_NAME = 'Path'
...
CONTENT_SCHEMA_PREFIX = 'ds'
XPATH_NAMESPACE = {CONTENT_SCHEMA_PREFIX: CONTENT_SCHEMA_NAMESPACE}
...
DESTINATIONS_TAG_NAME = 'destinations'
